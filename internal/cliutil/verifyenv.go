...
// VerifyEnvVar is the env var the  verifier sets in every
...
// DogfoodEnvVar is the env var the  live-dogfood runner
...
//
//	verifier in mock mode. Generated commands with side
//
...
// family used by codegen-marked `agent:read-only` operations on mutating
...
// the  live-dogfood matrix. Long-running commands (full
