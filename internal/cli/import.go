...
but do not stop the import.`,
  ...
  garmin-connect-workout-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  garmin-connect-workout-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | garmin-connect-workout-cli import <resource> --input -`,
